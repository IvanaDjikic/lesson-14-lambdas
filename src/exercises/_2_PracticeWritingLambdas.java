...
class _2_PracticeWritingLambdas {
	...
	Function<Integer, String> EVEN_ODD_LAMBDA = a -> {
		if (a % 2 == 0) {
			return "even";
		} else {
			return "odd";
	...
	Function<Character, Integer> ASCII_LAMBDA = a -> (int) a;
	Function<String, String> CAPITALIZE_LAMBDA = a -> a.substring(0, 1).toUpperCase() + a.substring(1);
